...
export function HomeScreen({ navigation }: Props): React.JSX.Element {
  ...
  useEffect(() => {
    setIsLoading(true);
    fetchBusinesses(1, debouncedQuery, selectedCategoryId, false).finally(
      () => setIsLoading(false),
    );
  }, [debouncedQuery, selectedCategoryId, fetchBusinesses]);
  ...
  const handleLoadMore = useCallback(() => {
    ...
    fetchBusinesses(page + 1, debouncedQuery, selectedCategoryId, true).finally(
      () => setIsLoadingMore(false),
    );
  }, [isLoadingMore, hasMore, isLoading, page, debouncedQuery, selectedCategoryId, fetchBusinesses]);
